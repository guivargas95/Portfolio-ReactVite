export default function Destaques() {
    return (
        ...
        // <section className="w-96 mt-5 text-white">
        //     <div className="flex-col relative">
        //         <p className="absolute left-1/2 bottom-0">asd</p>
        //         <img src="/assets/noticias/imagens/noticias.png" alt=""/>
        //     </div>
        //     <div className="flex-col columns-2 mt-2">
        //         <ul>
        //             <li>
        //                 <p className="absolute">asd</p>
        //                 <img src="/assets/noticias/imagens/noticias.png" alt="" />
        //             </li>
        //             <li>
        //                 <p className="absolute">asd</p>
