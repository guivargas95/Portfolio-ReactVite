    ...
    return (
        <div className="items-center mt-2 flex flex-col md:content-around lg:mr-5">
            ...
            <ul className="flex justify-center mt-5 mb-5 md:w-96 md:justify-around">
                <li><a href="#"><img src="/assets/icons/linkedin.png" className="w-16 md:w-20 p-1" alt="Linkedin" /></a></li>
                <li><a href="#"><img src="/assets/icons/github.png" className="w-16 md:w-20 p-1" alt="Github" /></a></li>
                <li><a href="#"><img src="/assets/icons/instagram.png" className="w-16 md:w-20 p-1" alt="Instagram" /></a></li>
            </ul>
        </div>
    )
}